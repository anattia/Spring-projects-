                                ...
                                <tbody>
                                    <c:forEach items="${ListComms}" var="comms">
                                        <tr>
                                            ...
                                            <td><c:out value="${comms.username}"/></td>
                                            <td><c:out value="${comms.comment_text}"/></td>

                                            <td><fmt:formatDate pattern="dd-MM-yyyy" 
                                                            value="${comms.comment_date}" /></td>
                                            <td><c:out value="${comms.cat_id}"/></td>
                                            <td><c:out value="${comms.topic_id}"/></td>
                                            <td class="text-center">
                                                <a href="ValidationComments?action=voir&idComment=${comms.comment_id}" class="btn btn-primary btn-xs">
                                                    <span class="fa fa-eye"></span> Validier </a></td>
