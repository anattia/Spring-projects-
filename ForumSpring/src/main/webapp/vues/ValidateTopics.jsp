                                            ...
                                            <c:forEach items="${ListTopics}" var="top">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="ListeTopicsValidate?action=valider&idTopic=${top.topic_id}" class="btn btn-primary btn-xs">
                                                            <span class="fa fa-eye"></span> Valider </a></td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            <a href="ListeTopicsValidate?action=typePrive&idTopic=${top.topic_id}" class="btn btn-danger btn-xs">
                                                                <span class="fa fa-trash-o"></span>Passer en privé</a></td>
                                                            </c:if>
                                                            <c:if test="${top.type_topic == 'Privé'}">
                                                        <td class="text-center">
                                                            <a href="ListeTopicsValidate?action=typePublic&idTopic=${top.topic_id}" class="btn btn-danger btn-xs">
